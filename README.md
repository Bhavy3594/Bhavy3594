...
### **Software Developer | Mobile • Web • Desktop • Data Analytics**
...
- 📱 **Mobile Application Engineering:** Building native Android applications in Java with clean UI/UX architecture, Firebase Realtime Database integration, and modular component workflows.
- 💻 **Full-Stack Web Development:** Developing enterprise web applications using PHP, Laravel MVC, Blade templating, and MySQL relational database management.
- ⚙️ **Desktop Software Architecture:** Crafting robust desktop applications in Java (Swing) and Python (Tkinter) with relational database persistence and transaction logging.
- 📊 **Data Science & Empirical Analytics:** Performing statistical modeling, data transformations, and high-resolution spatial visualizations using R (`ggplot2`, `dplyr`) and Python.
...
<table>
  ...
  <tr>
    <td valign="top"><b>Mobile & Cloud</b></td>
    <td>
  ...
  <tr>
    <td valign="top"><b>Web & Backend</b></td>
    <td>
  ...
  <tr>
    <td valign="top"><b>Desktop & Analytics</b></td>
    <td>
      <img src="https://img.shields.io/badge/Java_Swing-007396?style=for-the-badge&logo=openjdk&logoColor=white" alt="Java Swing" />
